...
CoAP::CoAP(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->srcAddress = 0;
    this->destAddress = 0;
    this->type = 0;
...
CoAP::CoAP(const CoAP& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
int CoAP::getSrcAddress() const
{
    return this->srcAddress;
}

void CoAP::setSrcAddress(int srcAddress)
{
    this->srcAddress = srcAddress;
}

int CoAP::getDestAddress() const
{
    return this->destAddress;
}

void CoAP::setDestAddress(int destAddress)
{
...
int CoAP::getPacketSize() const
{
    return this->packetSize;
}

void CoAP::setPacketSize(int packetSize)
{
...
CoAPDescriptor::CoAPDescriptor() : omnetpp::cClassDescriptor("CoAP", "omnetpp::cPacket")
{
...
int CoAPDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='c' && strcmp(fieldName, "code")==0) return base+3;
    if (fieldName[0]=='h' && strcmp(fieldName, "hasToken")==0) return base+4;
    if (fieldName[0]=='h' && strcmp(fieldName, "hasOptions")==0) return base+5;
    if (fieldName[0]=='h' && strcmp(fieldName, "hasPayload")==0) return base+6;
...
std::string CoAPDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return enum2string(pp->getType(), "packetType");
        case 3: return enum2string(pp->getCode(), "packetCode");
        case 4: return bool2string(pp->getHasToken());
        case 5: return bool2string(pp->getHasOptions());
        case 6: return bool2string(pp->getHasPayload());
...
bool CoAPDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setType((packetType)string2enum(value, "packetType")); return true;
        case 3: pp->setCode((packetCode)string2enum(value, "packetCode")); return true;
        case 4: pp->setHasToken(string2bool(value)); return true;
        case 5: pp->setHasOptions(string2bool(value)); return true;
        case 6: pp->setHasPayload(string2bool(value)); return true;
