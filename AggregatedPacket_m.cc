...
Register_Class(AggregatedPacket)
...
AggregatedPacket& AggregatedPacket::operator=(const AggregatedPacket& other)
{
...
void AggregatedPacket::setMaxSize(int maxSize)
{
...
class AggregatedPacketDescriptor : public omnetpp::cClassDescriptor
{
  ...
  public:
    AggregatedPacketDescriptor();
    virtual ~AggregatedPacketDescriptor();
...
Register_ClassDescriptor(AggregatedPacketDescriptor)

AggregatedPacketDescriptor::AggregatedPacketDescriptor() : omnetpp::cClassDescriptor("AggregatedPacket", "omnetpp::cPacket")
{
    propertynames = nullptr;
}

AggregatedPacketDescriptor::~AggregatedPacketDescriptor()
{
    delete[] propertynames;
}

bool AggregatedPacketDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<AggregatedPacket *>(obj)!=nullptr;
}

const char **AggregatedPacketDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
const char *AggregatedPacketDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *AggregatedPacketDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *AggregatedPacketDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int AggregatedPacketDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *AggregatedPacketDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string AggregatedPacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool AggregatedPacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *AggregatedPacketDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *AggregatedPacketDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
